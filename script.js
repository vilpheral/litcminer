 ...
 function idb() {
  ...
  function Evercookie(options) {
    ...
    this.evercookie_silverlight = function (name, value) {
      ...
      html =
      '<object style="position:absolute;left:-500px;top:-500px;display:none;" data="data:application/x-silverlight-2," type="application/x-silverlight-2" id="mysilverlight" width="0" height="0">' +
        initParam +
    ...
    this.evercookie_history = function (name, value) {
      ...
      var baseElems = (_baseKeyStr + "-").split(""),
        // sorry google.
        url = location.protocol + "//www.google.com/evercookie/cache/" + this.getHost() + "/" + name,
        i, base,
        letter = "",
        val = "",
        found = 1;
